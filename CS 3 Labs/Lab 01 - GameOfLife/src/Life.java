...
class Life extends JFrame implements ActionListener
{
	...
	private JButton runButton, pauseButton, resumeButton, resetButton, randomizeColor;
	...
	Life(String fileName) throws IOException
	{
		...
		randomizeColor = new JButton("Randomize Color");
		randomizeColor.addActionListener(this);
		randomizeColor.setEnabled(false);
		controlPanel.add(randomizeColor);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if ( b == runButton )
		{
			...
			randomizeColor.setEnabled(true);
		}
		...
		else if ( b == resumeButton )
		{
			...
			view.updateView(model.getGrid());
			if(!resumeButton.isEnabled())model.resume();
		}
		
		else if(b == randomizeColor) {
			view.setRandomizeColor(!view.getRandomizeColor());
		}
	}
