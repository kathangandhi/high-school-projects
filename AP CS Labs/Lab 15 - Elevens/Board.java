...
public abstract class Board {
     ...
     */
    public Board(int boardSize, int[] pointVals) {
        cards = new Card[boardSize];
        deck = new Deck(RANKS, SUITS, pointVals);
        if (I_AM_DEBUGGING) {
     ...
     */
    public abstract boolean containsExc(List<Integer> selectedCards);
}
